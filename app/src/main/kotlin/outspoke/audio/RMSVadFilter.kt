...
import dev.brgr.outspoke.audio.RMSVadFilter.Companion.HANGOVER_FRAMES
import dev.brgr.outspoke.audio.RMSVadFilter.Companion.LEAD_IN_FRAMES
import dev.brgr.outspoke.audio.RMSVadFilter.Companion.ONSET_FRAMES
 ...
 */
class RMSVadFilter(sensitivity: Float = 0.5f) : VadFilter {
